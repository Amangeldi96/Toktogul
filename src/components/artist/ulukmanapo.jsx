...
import '../css/ulukmanapo.css';

export default function Ulukmanapo() {
    // Initialize the rating from localStorage or default to 0
    ...
    useEffect(() => {
        // Set the rating from localStorage when the component mounts
    ...
    return (
        <div className="h-block">
            <h1 className="f-block">Ulukmanapo</h1>
            <div className="h-content">
                <div className="img-ulukmanapo"></div>
