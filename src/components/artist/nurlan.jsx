...
import '../css/nurlan.css';

export default function Nurlan() {
    ...
    return (
        <div className="h-block">
            <h1 className="f-block">Нурлан Насип</h1>
            <div className="h-content">
                <div className="img-nurlan"></div>
