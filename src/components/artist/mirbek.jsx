...
import '../css/mirbek.css';

export default function Mirbek() {
    ...
    return (
        <div className="h-block">
            <h1 className="f-block">Мирбек Атабеков</h1>
            <div className="h-content">
                <div className="img-mirbek"></div>
